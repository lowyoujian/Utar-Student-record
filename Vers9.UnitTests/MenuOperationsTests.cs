...
namespace Vers9.UnitTests
{
    ...
    public class MenuOperationsTests
    {
        ...
        [Test]
        public void LoadSubjectList_AND_LoadMultipleStudentRecords_AND_VerifyStudentRecords_AND_CalculateGradesForStudentRecords_AND_DisplayStudentRecords()
        {
            string[] simulatedValuesToReturn = new string[5];
